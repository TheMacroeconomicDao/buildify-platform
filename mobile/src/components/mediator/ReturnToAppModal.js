...
export default function ReturnToAppModal({visible, onClose, onConfirm, t}) {
            ...
            <View style={localStyles.modalContent}>
              ...
              <View style={localStyles.header}>
                <Text style={localStyles.title}>
                  {t('Return Order to App')}
                </Text>
                <Text style={localStyles.subtitle}>
                  {t(
                    'The order will be returned to the general list for other executors to respond. Please provide a reason.',
                  )}
                </Text>
              </View>
              ...
              <View style={localStyles.inputSection}>
                ...
                <TextArea
                  placeholder={t('Enter reason for returning to app...')}
                  value={reason}
              ...
              <View style={localStyles.infoContainer}>
                <Text style={localStyles.infoText}>
                  ℹ️{' '}
                  {t(
                    'After returning, other executors will be able to respond to this order',
                  )}
                </Text>
              </View>
