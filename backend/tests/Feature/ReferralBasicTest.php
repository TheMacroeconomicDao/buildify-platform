...
class ReferralBasicTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_referral_code_is_created_for_new_user()
    {
    ...
    public function test_referral_registration_creates_referral_relationship()
    {
        // Создаём реферрера
    ...
    public function test_user_cannot_use_own_referral_code()
    {
        $user = User::factory()->create(['type' => Type::Executor->value]);
    ...
    public function test_only_executors_can_be_referrals()
    {
    ...
    public function test_referral_stats_are_calculated_correctly()
    {
    ...
    public function test_referral_balance_can_be_used()
    {
        $user = User::factory()->create([
            'type' => Type::Executor->value,
    ...
    public function test_cannot_use_more_than_available_referral_balance()
    {
        $user = User::factory()->create([
            'type' => Type::Executor->value,
    ...
    public function test_referral_api_endpoints_require_authentication()
    {
        // Тестируем, что API требует аутентификации
        ...
        $response = $this->postJson('/api/referrals/use-balance', ['amount' => 10]);
        $response->assertStatus(401);
    }
}
